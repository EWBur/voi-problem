...
nVois = 0*nCities
nTimeSteps = 100
mutationProbabilityAgents = 0.01
nGroups = int(nAgents)
...
passPerNodeOT = np.zeros(nCities)
hvc = 2 * nCities

voiDistributionH = [5, 3, 4, 1, 6, 1, 3, 1, 1, 4, 2, 1, 1, 1, 3, 0, 3, 4, 1, 3, 3, 0, 5, 2, 1, 1, 0, 0, 0, 0]

voiPositions = voiDistributionH
